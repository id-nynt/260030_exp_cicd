...
public final class JasonBeliefAdapter implements BeliefAdapter {
    ...
    public String convert(Observation observation) {
        ...
        return switch (property) {
            ...
            case "health" -> "status(" + entity + "," + healthValue(value) + ")";
    ...
    private static String healthValue(Object value) {
        return "healthy".equalsIgnoreCase(String.valueOf(value)) ? "success" : "fail";
    }
